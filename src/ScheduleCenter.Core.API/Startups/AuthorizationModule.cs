...
namespace ScheduleCenter.Core.API.Startups
{
    public static class AuthorizationModule
    {
        public static void AddAuthService(this IServiceCollection service, IConfiguration configuration)
        {
            ...
            {
                SecretKey = Appsettings.app(new string[] { "ScheduleCenter", "JwtConfig", "SecretKey" }),
                Issuer = Appsettings.app(new string[] { "ScheduleCenter", "JwtConfig", "Issuer" }),
                Audience = Appsettings.app(new string[] { "ScheduleCenter", "JwtConfig", "Audience" }),
                ExpireMins = int.Parse(Appsettings.app(new string[] { "ScheduleCenter", "JwtConfig", "ExpireMins" }))
            };
            //注入配置类
            service.Configure<JwtConfig>(configuration.GetSection("ScheduleCenter:JwtConfig"));
