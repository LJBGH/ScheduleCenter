...
/// SqlSugar仓储层拓展
/// </summary>
namespace ScheduleCenter.SqlSugar.Repository
{
    public class SqlSugarRepository<T> : ISqlSugarRepository<T> where T : class, new()
    {
        ...
        {
            var conn = Appsettings.app(new string[] { "ScheduleCenter", "DbContexts", "ConnectionString" });
            var dbtype = Appsettings.app(new string[] { "ScheduleCenter", "DbContexts", "DataBaseType" });
